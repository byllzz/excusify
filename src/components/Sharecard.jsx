  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '28px' }}>
        ...
        />
        <span style={{ marginLeft: 10, fontSize: 11, color: '#52525b', letterSpacing: 1 }}>
          excusify — bash
        </span>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 28 }}>
        ...
        <p style={{ color: '#f4f4f5', fontSize: 15, lineHeight: 1.7, margin: 0 }}>{excuse}</p>
      </div>
      ...
      >
        ...
        <span style={{ fontSize: 11, color: '#3f3f46', letterSpacing: 0.5 }}>
          excusify.vercel.app
        </span>
      </div>
    </div>
